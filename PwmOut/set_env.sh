#!/bin/sh
# setup environment for PWM out

echo "Set up environment for PWM out"
...
echo 0x5> /sys/kernel/debug/omap_mux/mcasp0_ahclkx
echo "# p9 - 27  mcasp0_fsr"
echo 0x5 > /sys/kernel/debug/omap_mux/mcasp0_fsr
echo "# p9 - 28  mcasp0_ahclkr"
echo 0x5 > /sys/kernel/debug/omap_mux/mcasp0_ahclkr
echo "# p9 - 29  mcasp0_fsx"
echo 0x5 > /sys/kernel/debug/omap_mux/mcasp0_fsx
echo "# p9 - 30  mcasp0_axr0"
echo 0x5 > /sys/kernel/debug/omap_mux/mcasp0_axr0
echo "# p9 - 31  mcasp0_aclkx"
echo 0x5 > /sys/kernel/debug/omap_mux/mcasp0_aclkx
...
echo 0x5 > /sys/kernel/debug/omap_mux/gpmc_csn0
